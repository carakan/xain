  ...
  test "ensure_valid_contents raises error if String.Chars is not implemented for the first argument" do
    assert capture_log(fn ->
             assert_raise Protocol.UndefinedError,
                          "protocol String.Chars not implemented for %{} of type Map. This protocol is implemented for the following type(s): Float, DateTime, Time, List, Version.Requirement, Atom, Integer, Version, Date, BitString, NaiveDateTime, URI",
                          fn ->
